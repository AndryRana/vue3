<template>
	<div class="m-auto">
        ...
        <section class=" flex justify-between my-4">
            <button class=" px-2 border rounded" @click="prev">Prec</button>
            <button class=" px-2 border rounded" @click="next">Suiv</button>
        </section>
	</div>
</template>
...
export default {
    ...
    methods: { 
        ...
        currentDateClass(num) {
            ...
            return calendarFullDate === currentFullDate ? 'bg-gray-500 text-white': '';
        },
    },
